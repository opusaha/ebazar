            ...
            <div class="row align-items-center">
                <div class="border-0 mb-4">
                    <div
                        ...
                        <h3 class="fw-bold mb-0">Seller Profile</h3>
                    </div>
                </div>
            </div> <!-- Row end  -->
            <div class="row g-3">
                    ...
                    <div class="card profile-card flex-column mb-3">
                        ...
                        <div class="card-body d-flex profile-fulldeatil flex-column">
                            <div class="profile-block text-center w220 mx-auto">
                                <a href="#">
                                    <img src="https://pixelwibes.com/template/ebazar/laravel/public/backend/dist/assets/images/lg/avatar4.svg"
                                ...
                                <div class="about-info d-flex align-items-center mt-3 justify-content-center flex-column">
                                    <span class="text-muted small">Seller ID : PXL-0001</span>
                                </div>
                            </div>
                    ...
                    <div class="card mb-3">
                        ...
                        <div class="card-body">
                            <div class="payment-info">
                                <h5 class="payment-name text-muted"><i class="icofont-visa-alt fs-3"></i> Visa *******7548
                                </h5>
