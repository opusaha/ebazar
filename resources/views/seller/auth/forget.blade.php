...
<head>
    ...
    <title>::eBazar:: forgetPassword</title>
                            ...
                            <div class="w-100 p-3 p-md-5 card border-0 shadow-sm" style="max-width: 32rem;">
                                ...
                                <form class="row g-1 p-3 p-md-4">
                                    <div class="col-12 text-center mb-5">
                                        <img src="https://pixelwibes.com/template/ebazar/laravel/public/backend/dist/assets/images/forgot-password.svg"
                                            class="w240 mb-4" alt="">
                                    ...
                                    <div class="col-12 text-center mt-4">
                                        <a href="https://pixelwibes.com/template/ebazar/laravel/public/backend/auth-two-step"
                                            title=""
                                            class="btn btn-lg btn-block btn-light lift text-uppercase">SUBMIT</a>
                                    </div>
                                    <div class="col-12 text-center mt-4">
                                        <span class="text-muted"><a
                                                href="{{route('seller.signin')}}"
