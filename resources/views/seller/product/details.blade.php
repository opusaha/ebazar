                                ...
                                <div class="col-lg-6">
                                    <div class="product-details-content mt-45">
                                        ...
                                        {{-- <div class="product-items flex-wrap">
                                            ...
                                            <div class="items-wrapper" id="select-item-1">
                                                ...
                                                <div class="single-item">
                                                    <div class="items-image">
                                                        <img src="{{asset($product->image_two)}}" alt="{{$product->name}}">
                                                    </div>
                                                    <p class="text">Oculus Quest</p>
                                                </div>
                                                <div class="single-item">
                                                    <div class="items-image">
                                                        <img src="{{asset($product->image_three)}}" alt="{{$product->name}}">
                                                    </div>
                                        ...
                                        <div class="product-price">
                                            ...
                                            <p class="sale-price">{{$product->price}} TK</p>
                                            <p class="regular-price text-danger">{{$product->old_price}} TK</p>
                                        </div>
                                        <p>  Product short details in here </p>
