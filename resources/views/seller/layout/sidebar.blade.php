<div class="sidebar px-4 py-4 py-md-4 me-0">
    <div class="d-flex flex-column h-100">
        <a href="{{route('seller.dashboard')}}" class="mb-0 brand-icon">
        ...
        <ul class="menu-list flex-grow-1 mt-3">
            <li><a class="m-link active" href="{{route('seller.dashboard')}}"><i class="icofont-home fs-5"></i> <span>Dashboard</span></a>
            </li>
            <li class="collapsed">
                ...
                <ul class="sub-menu collapse" id="menu-product">
                    <li><a class="ms-link" href="{{route('seller.product.index')}}">Product List</a></li>
                    <li><a class="ms-link" href="{{ route('seller.product.create') }}">Product Add</a></li>
                </ul>
            </li>
            <li class="collapsed">
                ...
                <ul class="sub-menu collapse" id="categories">
                    <li><a class="ms-link" href="{{route('admin.category.index')}}">Categories List</a></li>
                    <li><a class="ms-link" href="{{route('admin.category.create')}}">Categories Add</a></li>
                </ul>
            </li>
            <li class="collapsed">
            ...
            <li class="collapsed">
                ...
                <ul class="sub-menu collapse " id="Authentication">
                    <li><a class="ms-link "
                            href="{{route('seller.signin')}}">Sign
                            in</a></li>
                    <li><a class="ms-link "
                            href="{{route('seller.register')}}">Sign
                            up</a></li>
                    <li><a class="ms-link "
                            href="{{route('seller.forgot')}}">Password
                            reset</a></li>
                    <li><a class="ms-link "
                            href="https://pixelwibes.com/template/ebazar/laravel/public/backend/auth-two-step">2-Step
                            Authentication</a></li>
                    <li><a class="ms-link "
                            href="https://pixelwibes.com/template/ebazar/laravel/public/backend/auth-404">404</a></li>
                </ul>
            </li>
        </ul>
