...
<div class="body d-flex py-3">
    <div class="container-xxl">
        <form action="{{ route('seller.product.update',$id) }}" method="POST" enctype="multipart/form-data">@csrf
                            ...
                            <div class="row g-3 align-items-center">
                                ...
                                <div class="col-md-12">
                                    ...
                                    <div>
                                        ...
                                        <textarea name="details" style="width: 100%" rows="15">{{$product->details}}</textarea>
                                        @error('details')
                                            <div class="alert alert-danger">{{ $message }}</div>
                                        @enderror
                                    </div>
                                ...
                                <div class="col-md-12">
                                    ...
                                    <div>
                                        <h4>Enter Product Specification Here</h4>
                                        <textarea name="specification" style="width: 100%" rows="15">{{$product->specification}}</textarea>
                                        @error('specification')
                                            <div class="alert alert-danger">{{ $message }}</div>
                                        @enderror
                                    </div>
